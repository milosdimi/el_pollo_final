class Chicken extends MovableObject {
    ...
    constructor(x = 200 + Math.random() * 2500,
    ...
    animate() {
        ...
        this._anim = setInterval(() => this.playAnimation(this.IMAGES_WALKING_BIG_CHICKEN), 200);
    }
    ...
    die() {
        ...
        const deadPath = this.IMAGES_DEAD_BIG_CHICKEN[0];
