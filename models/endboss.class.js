class EndBoss extends MovableObject {
    height = 400; width = 250; y = 60;
    speed = 10; baseSpeed = 10; SPEED_HIT_BOOST = 10; MAX_SPEED = 15;
    offset = { top: 40, bottom: 35, left: 25, right: 30 };

    ANIM_FPS = 9; ALERT_MS = 2000; HURT_MS = 450; DEAD_FRAME_MS = 140; DEAD_HOLD_MS = 800;
    ATTACK_DIST = 60;
    ...
    _stopLoops() { clearInterval(this.aiLoop); clearInterval(this.animLoop); clearInterval(this._deadLoop); }
    ...
    _animStep() {
        ...
        if (this.state === 'dead') return this.playAnimation(imgs);
    ...
    isInView() {
        ...
        const left = -this.world.camera_x, right = left + this.world.canvas.width, pad = 8;
