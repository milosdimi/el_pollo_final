class ThrowableObject extends MovableObject {
    ...
    start() {
        this._fly = setInterval(() => (this.x += this.throwVx), 1000 / 60);
        this._spin = setInterval(() => this.playAnimation(this.IMAGES_ROTATE), 1000 / 20);
    }
    ...
    isAboveGround() {
        ...
        const ground = this.world?.groundY ?? 380;
        return this.y < ground - this.height || this.speedY > 0;
    }
}
