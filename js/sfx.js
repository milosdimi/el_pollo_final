class Sfx {
    ...
    _playRaw(name) {
        ...
        const n = s.cloneNode(); n.volume = s.volume; n.play();
    }
    ...
    setVolume(name, v) { const x = Math.max(0, Math.min(1, v)); this.vol[name] = x; if (this.sounds[name]) this.sounds[name].volume = x; }
